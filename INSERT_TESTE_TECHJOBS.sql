...
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (7.5, 8.0, 1, 3, '2024-09-08', 'Atividade 1 - Banco de Dados Relacional');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.2, 9.5, 1, 3, '2024-09-01', 'Atividade 2 - Banco de Dados Relacional');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.8, 9.0, 1, 2, '2024-09-15', 'Atividade 3 - Introdução à Programação');
...
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 10.0, 1, 4, '2024-09-04', 'Atividade 1 - Introdução à Física');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.0, 10.0, 1, 4, '2024-09-05', 'Atividade 2 - Introdução à Física');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.5, 10.0, 2, 3, '2024-09-02', 'Atividade 1 - Química Orgânica');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.7, 9.0, 2, 3, '2024-09-01', 'Atividade 2 - Química Orgânica');

-- Adicionando mais atividades para o curso de Matemática
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.0, 9.0, 1, 2, '2024-09-03', 'Atividade 4 - Álgebra Linear');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (7.5, 8.0, 1, 2, '2024-09-07', 'Atividade 5 - Cálculo Diferencial');

-- Adicionando mais atividades para o curso de Programação
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 10.0, 1, 1, '2024-09-05', 'Atividade 2 - Estruturas de Dados');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.5, 9.0, 1, 1, '2024-09-12', 'Atividade 3 - Algoritmos');

-- Adicionando mais atividades para o curso de Banco de Dados Relacional
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.2, 10.0, 1, 3, '2024-09-14', 'Atividade 3 - Modelagem de Dados');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.8, 8.5, 1, 3, '2024-09-14', 'Atividade 4 - Normalização');


-- Atividades em agosto
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.5, 10.0, 1, 1, '2024-08-10', 'Atividade 1 - Estruturas de Controle');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.0, 9.0, 2, 2, '2024-08-15', 'Atividade 1 - Geometria Analítica');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (7.5, 8.0, 1, 3, '2024-08-20', 'Atividade 1 - Consultas SQL');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 9.5, 2, 3, '2024-08-25', 'Atividade 1 - Banco de Dados NoSQL');

-- Atividades em julho
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.7, 9.0, 1, 2, '2024-07-05', 'Atividade 2 - Cálculo Integral');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.9, 9.2, 2, 1, '2024-07-12', 'Atividade 2 - Programação Funcional');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 10.0, 1, 3, '2024-07-20', 'Atividade 2 - Transações SQL');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.0, 8.5, 2, 2, '2024-07-30', 'Atividade 2 - Trigonometria');

-- Atividades em junho
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 9.5, 1, 1, '2024-06-05', 'Atividade 1 - Introdução à Lógica de Programação');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.5, 9.0, 2, 3, '2024-06-10', 'Atividade 1 - Fundamentos de Banco de Dados');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.2, 9.8, 1, 2, '2024-06-15', 'Atividade 1 - Funções e Derivadas');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.7, 9.0, 2, 2, '2024-06-25', 'Atividade 1 - Matrizes e Determinantes');

-- Atividades em maio
INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.0, 9.5, 1, 1, '2024-05-10', 'Atividade 1 - Algoritmos e Lógica de Programação');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (8.5, 9.0, 2, 2, '2024-05-20', 'Atividade 1 - Álgebra Booleana');

INSERT INTO `mydb`.`pontuacao` (`nota_aluno`, `nota_atividade`, `aluno_id`, `curso_id`, `data_entrega`, `nome_atividade`)
VALUES (9.3, 9.8, 1, 3, '2024-05-30', 'Atividade 1 - Consultas Avançadas SQL');
